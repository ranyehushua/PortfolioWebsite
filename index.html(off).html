      ...
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-6 col-lg-4">
          <a class="thumbnail" href="calculator/calculator.html">
            ...
            <div class="caption">A calculator application developed with vanilla JavaScript.</div>
          </a>
        </div>
        <!-- End Thumbnail #1 -->
        <!-- Start Thumbnail #2 -->
        ...
        <!-- Start Thumbnail #3 -->
        <div class="col-xs-12 col-sm-6 col-lg-4">
          <a class="thumbnail" href="img/DesolationHike.jpg">
            <img src="img/DesolationHike.jpg" class="img-responsive">
            <div class="caption">The hike up Desolation Ridge was challenging.</div>
          </a>
        </div>
        <!-- End Thumbnail #3 -->
        ...
        <!-- Start Thumbnail #4 -->
        <div class="col-xs-12 col-sm-6 col-lg-4">
          <a class="thumbnail" href="img/DesolationTop.jpg">
            <img src="img/DesolationTop.jpg" class="img-responsive">
            <div class="caption">The view from the top of Desolation Ridge was worth the effort!</div>
          </a>
        </div>
        <!-- End Thumbnail #4 -->
        <!-- Clearfix only visible on small and medium resolution (when in 2 column layout) -->
        ...
        <!-- Start Thumbnail #5 -->
        <div class="col-xs-12 col-sm-6 col-lg-4">
          <a class="thumbnail" href="img/GuacDrop.jpg">
            <img src="img/GuacDrop.jpg" class="img-responsive">
            <div class="caption">Time to switch gears, summer time mountain biking is right around the corner!</div>
          </a>
        </div>
        <!-- End Thumbnail #4 -->
      </div>
